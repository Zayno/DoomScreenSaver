...
action_t actions[] =
{
    { "+alwaysrun",      true,  false, alwaysrun_action_func,       &keyboardalwaysrun,      &keyboardalwaysrun2,      NULL,        NULL,       NULL            },
    { "+automap",        false, false, automap_action_func,         &keyboardautomap,        &keyboardautomap2,        NULL,        NULL,       NULL            },
    { "+back",           true,  false, back_action_func,            &keyboardback,           &keyboardback2,           NULL,        NULL,       NULL            },
    { "+bfg9000",        true,  false, bfg9000_action_func,         &keyboardbfg9000,        &keyboardbfg90002,        NULL,        NULL,       NULL            },
    { "+chaingun",       true,  false, chaingun_action_func,        &keyboardchaingun,       &keyboardchaingun2,       NULL,        NULL,       NULL            },
    { "+chainsaw",       true,  false, chainsaw_action_func,        &keyboardchainsaw,       &keyboardchainsaw2,       NULL,        NULL,       NULL            },
    { "+clearmark",      true,  true,  clearmark_action_func,       &keyboardclearmark,      &keyboardclearmark2,      NULL,        NULL,       NULL            },
    { "+console",        false, false, console_action_func,         &keyboardconsole,        &keyboardconsole2,        NULL,        NULL,       NULL            },
    { "+fire",           true,  false, fire_action_func,            &keyboardfire,           &keyboardfire2,           NULL,        NULL,       NULL            },
    { "+fists",          true,  false, fists_action_func,           &keyboardfists,          &keyboardfists2,          NULL,        NULL,       NULL            },
    { "+followmode",     true,  true,  followmode_action_func,      &keyboardfollowmode,     &keyboardfollowmode2,     NULL,        NULL,       NULL            },
    { "+forward",        true,  false, forward_action_func,         &keyboardforward,        &keyboardforward2,        NULL,        NULL,       NULL            },
    { "+freelook",       true,  false, NULL,                        &keyboardfreelook,       &keyboardfreelook2,       NULL,        NULL,       NULL            },
    { "+grid",           true,  true,  grid_action_func,            &keyboardgrid,           &keyboardgrid2,           NULL,        NULL,       NULL            },
    { "+jump",           true,  false, jump_action_func,            &keyboardjump,           &keyboardjump2,           NULL,        NULL,       NULL            },
    { "+left",           true,  false, left_action_func,            &keyboardleft,           &keyboardleft2,           NULL,        NULL,       NULL            },
    { "+mark",           true,  true,  mark_action_func,            &keyboardmark,           &keyboardmark2,           NULL,        NULL,       NULL            },
    { "+maxzoom",        true,  true,  maxzoom_action_func,         &keyboardmaxzoom,        &keyboardmaxzoom2,        NULL,        NULL,       NULL            },
    { "+menu",           true,  false, menu_action_func,            &keyboardmenu,           &keyboardmenu2,           NULL,        NULL,       NULL            },
    { "+nextweapon",     true,  false, nextweapon_action_func,      &keyboardnextweapon,     &keyboardnextweapon2,     NULL,        NULL,       NULL            },
    { "+path",           true,  false, path_action_func,            &keyboardpath,           &keyboardpath2,           NULL,        NULL,       NULL            },
    { "+pistol",         true,  false, pistol_action_func,          &keyboardpistol,         &keyboardpistol2,         NULL,        NULL,       NULL            },
    { "+plasmarifle",    true,  false, plasmarifle_action_func,     &keyboardplasmarifle,    &keyboardplasmarifle2,    NULL,        NULL,       NULL            },
    { "+prevweapon",     true,  false, prevweapon_action_func,      &keyboardprevweapon,     &keyboardprevweapon2,     NULL,        NULL,       NULL            },
    { "+right",          true,  false, right_action_func,           &keyboardright,          &keyboardright2,          NULL,        NULL,       NULL            },
    { "+rocketlauncher", true,  false, rocketlauncher_action_func,  &keyboardrocketlauncher, &keyboardrocketlauncher2, NULL,        NULL,       NULL            },
    { "+rotatemode",     true,  true,  rotatemode_action_func,      &keyboardrotatemode,     &keyboardrotatemode2,     NULL,        NULL,       NULL            },
    { "+run",            true,  false, NULL,                        &keyboardrun,            &keyboardrun2,            NULL,        NULL,       NULL            },
    { "+screenshot",     false, false, screenshot_action_func,      &keyboardscreenshot,     &keyboardscreenshot2,     NULL,        NULL,       NULL            },
    { "+shotgun",        true,  false, shotgun_action_func,         &keyboardshotgun,        &keyboardshotgun2,        NULL,        NULL,       NULL            },
    { "+strafe",         true,  false, NULL,                        &keyboardstrafe,         &keyboardstrafe2,         NULL,        NULL,       NULL            },
    { "+strafeleft",     true,  false, strafeleft_action_func,      &keyboardstrafeleft,     &keyboardstrafeleft2,     NULL,        NULL,       NULL            },
    { "+straferight",    true,  false, straferight_action_func,     &keyboardstraferight,    &keyboardstraferight2,    NULL,        NULL,       NULL            },
    { "+supershotgun",   true,  false, supershotgun_action_func,    &keyboardsupershotgun,   &keyboardsupershotgun2,   NULL,        NULL,       NULL            },
    { "+use",            true,  false, use_action_func,             &keyboarduse,            &keyboarduse2,            NULL,        NULL,       NULL            },
    { "+weapon1",        true,  false, weapon1_action_func,         &keyboardweapon1,        &keyboardweapon1_2,       NULL,        NULL,       NULL            },
    { "+weapon2",        true,  false, weapon2_action_func,         &keyboardweapon2,        &keyboardweapon2_2,       NULL,        NULL,       NULL            },
    { "+weapon3",        true,  false, weapon3_action_func,         &keyboardweapon3,        &keyboardweapon3_2,       NULL,        NULL,       NULL            },
    { "+weapon4",        true,  false, weapon4_action_func,         &keyboardweapon4,        &keyboardweapon4_2,       NULL,        NULL,       NULL            },
    { "+weapon5",        true,  false, weapon5_action_func,         &keyboardweapon5,        &keyboardweapon5_2,       NULL,        NULL,       NULL            },
    { "+weapon6",        true,  false, weapon6_action_func,         &keyboardweapon6,        &keyboardweapon6_2,       NULL,        NULL,       NULL            },
    { "+weapon7",        true,  false, weapon7_action_func,         &keyboardweapon7,        &keyboardweapon7_2,       NULL,        NULL,       NULL            },
    { "+zoomin",         true,  true,  zoomin_action_func,          &keyboardzoomin,         &keyboardzoomin2,         NULL,        NULL,       NULL            },
    { "+zoomout",        true,  true,  zoomout_action_func,         &keyboardzoomout,        &keyboardzoomout2,        NULL,        NULL,       NULL            },
...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_BOOL(am_mousepanning, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS,
        "Toggles panning using the mouse in the automap when follow mode is off."),
    ...
    CVAR_BOOL(joy_rumble_fall, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS,
    ...
    CVAR_INT(r_extralighting, "", "", int_cvars_func1, int_cvars_func2, CF_PERCENT, NOVALUEALIAS,
    ...
    CVAR_BOOL(r_percolumnlighting, "", "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS,
...
{
    return ((gamekeydown[keyboardrun] || gamekeydown[keyboardrun2]) ^ alwaysrun);
}

static bool strafe(void)
{
    return (gamekeydown[keyboardstrafe] || gamekeydown[keyboardstrafe2]);
}
...
void bind_func2(char *cmd, char *parms)
{
    ...
    if (freelookcontrols != (keyboardfreelook || keyboardfreelook2 ))
    {
        if (gamestate == GS_LEVEL)
        {
