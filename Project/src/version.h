...
#define DOOMRETRO_VERSION               5,8,2,0
#define DOOMRETRO_VERSIONSTRING         "5.8.2"
#define DOOMRETRO_NAMEANDVERSIONSTRING  "DOOM Retro v5.8.2"
...
#define SCREEN_SAVER_MUTEX              "2XFnBXa4r6fKBuXp+mjs2H29poLtcwujaEIsOIbHZmU="
